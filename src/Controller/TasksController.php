...
class TasksController extends AbstractController
{
    ...
    #[Route('/sort', name: 'app_tasks_sort', methods: ['GET'])]
    public function sort(TasksRepository $tasksRepository): Response
    {
        return $this->render('tasks/index.html.twig', [
            'tasks' => $tasksRepository->findBy(array(), array('deadline' => 'ASC')),
        ]);
    }

    #[Route('/filter', name: 'app_tasks_filter', methods: ['GET'])]
    public function search(TasksRepository $tasksRepository): Response
    {
        return $this->render('tasks/index.html.twig', [
            'tasks' => $tasksRepository->findBy(array('taskname' => 'Lerning'), array('taskname' => 'ASC')),
        ]);
    }
    ...
    {
        // $task = $doctrine->getRepository(Task::class)->findAll();
